...
const PasswordInput = ({password, setPassword}) => {
  ...
  return (
    <div className="">
      <label htmlFor="pass" className="text-[12px] font-normal text-white">
      ...
      <div className="relative mt-1">
        ...
        />
        <div
          className="absolute top-4.5 right-4 text-2xl text-[#ACB0B1] text-muted-foreground cursor-pointer"
            ...
            <div className='p-3 lg:w-[600px] mx-auto flex-1 lg:h-[784px]'>
                    <div className='flex lg:p-12 lg:px-8 rounded-[8px] mt-[8rem] flex-col gap-6 bg-gradient-to-r from-[#100E24] to-[#100E24] border border-[#3B3C9A99] p-4'>
                        ...
                        <div className='flex flex-col gap-2 lg:mt-5 text-[24px]'>
                            ...
                            <p className='text-white opacity-80 lg:opacity-50 text-[14px] w-full'>Log in to track trades and manage your account.</p>
                        </div>
                        ...
                        <div className='flex flex-col gap-4'>
                            ...
                            <div className='flex flex-col gap-2 mb-5 w-full'>
                                <PasswordInput 
                                    ...
                                    className=''
                                />
                                <Link to='/forgot-password?' className='text-[12px] text-[#5759D0]'>Forgot Password?</Link>
                            </div>
                            </div>  
                        </div>
                        ...
                        <div className='flex flex-col gap-4'>
                            ...
                            <div className='w-full text-center'>
                                <p className='text-white text-[12px] opacity-80'>Don't have an account? <Link to='/signup'>
                                        <span className='text-[#5759D0] hover:underline'>Create account</span>
                                    </Link>
                                </p>
                            </div>
                        </div>
